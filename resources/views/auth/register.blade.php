...
@section('content')
  ...
  {!! Form::open() !!}
    ...
    <div class="form-group">
      {!! Form::label('username', 'Username', ['class' => 'sr-only', 'for' => 'inputUsername']) !!}
      {!! Form::input('text', 'username', old('username'), ['class' => 'form-control', 'id' => 'inputUsername', 'placeholder'=>'Username']) !!}
    </div>
