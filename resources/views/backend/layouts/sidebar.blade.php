      ...
      <ul class="sidebar-menu">
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ route('admin.admin-users.inde') }}"><i class="fa fa-user-secret"></i> <span>Admin Users</span></a></li>
               <li><a href="{{ route('admin.users.index') }}"><i class="fa fa-user"></i> <span>Users</span></a></li>
            </ul>
         </li>
         <li class="header">MANAGER</li>
         <li><a href="{!! route('admin.categories.index') !!}"><i class="fa fa-link"></i> <span>Category</span></a></li>
