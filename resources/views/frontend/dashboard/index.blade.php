        ...
        <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption" >
                <h4>{{ $product->name }}</h4>
                <p>{{ $product->price }}</p>
                <p><a href="{!! route('cart.buy', [$product->id, $product->slug]) !!}" class="btn btn-primary" role="button">Add Cart</a> <a href="{!! url('detail/'. $product->id) !!}" class="btn btn-success" role="button">View Detail</a></p>
              </div>
            </div>
         </div>
         @endforeach
